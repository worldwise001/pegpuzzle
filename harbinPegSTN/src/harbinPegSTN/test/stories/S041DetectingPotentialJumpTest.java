...
SaveTheNetworkModel model = null;
	...
	public void testCheckJump(){
		...
		assertTrue("White potential jump from 10 to 24", model.checkJump(10, 24));
		assertTrue("White potential jump from 10 to 9", model.checkJump(10, 9));
		assertFalse("Illegal move from 10 to 22",model.checkJump(10, 22));
